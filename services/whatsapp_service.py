...
async def send_interactive_list(to_phone: str, text_body: str, button_label: str, sections: list) -> dict | None:
    """Envía un menú desplegable (type: list) con secciones y filas seleccionables."""
    url = (
        f"https://graph.facebook.com/{settings.whatsapp_api_version}"
        f"/{settings.whatsapp_phone_id}/messages"
    )
